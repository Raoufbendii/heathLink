                ...
                <tr >
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Doctor name, Email or Specialty" list="doctors">&nbsp;&nbsp;
                            
                            <?php
                                echo '<datalist id="doctors">';
                                $list11 = $database->query("select docname, docemail, specialties from doctor;");
                            ...
                            <?php
                                ...
                                if($result->num_rows==0){
                                    ...
                                    for ( $x=0; $x<$result->num_rows; $x++){
                                        ...
                                        // Fetch specialty name if available
                                        if (!empty($spe)) {
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td>
                                    <p style="text-align: left;font-size: 25px;font-weight: 500;">View Doctor Details.</p>
                                    <br><br>
                                </td>
                            </tr>
